...
<div
	class="bg-surface-container fixed right-0 bottom-5 left-23 mx-8 flex h-24 items-center justify-between rounded-full"
>
	<div class="grid h-full w-full grid-cols-3 items-center">
		<div class="ml-6 flex items-center justify-start gap-2">
			...
			<div class="flex flex-col">
				<p class="song-title text-primary">Song Name</p>
		...
		<div class="flex justify-center gap-2">
			...
			<div class="button-mod">
				<Button iconType="full" square variant="tonal">
					<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
						><path fill="currentColor" d="M8 19V5l11 7zm2-3.65L15.25 12L10 8.65z" /></svg
					>
				</Button>
			</div>
			<div class="button-mod-2">
		...
		<div class="mr-6 flex items-center justify-end">
			...
			<div class="slider-stuff">
				<Slider min={0} max={100} value={50} step={1} showValue format={(n) => `${n}%`} />
			</div>
			<div class="mr-2 ml-2">
				<svg
					class="fill-icon-color"
