...
<div class="flex flex-col items-center justify-center min-h-[70vh] px-6 py-8">
    <div class="max-w-3xl w-full space-y-10">
        <div class="flex flex-col items-center gap-6">
            <div class="bg-primary-container text-on-primary-container p-6 rounded-[2rem]">
                <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M12 3v10.55c-.59-.34-1.27-.55-2-.55c-2.21 0-4 1.79-4 4s1.79 4 4 4s4-1.79 4-4V7h4V3z"/>
                </svg>
            </div>
            <h1 class="text-4xl font-bold text-center tracking-tight">Welcome to Maple</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card variant="filled">
                <div class="flex flex-col items-center gap-4 py-6 px-4 h-full">
                    ...
                    <p class="text-sm text-on-surface-variant text-center flex-grow">
                        Track your listening history, connect with friends, and sync across devices.
                    </p> 
                    <Button variant="tonal" onclick={() => goto('/register')}>
                        Get Started
                    </Button>
                </div>
            </Card>
            ...
            <Card variant="outlined">
                <div class="flex flex-col items-center gap-4 py-6 px-4 h-full">
                    <div class="bg-secondary-container text-on-secondary-container p-3 rounded-2xl">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 21v-2h7V5h-7V3h7q.825 0 1.413.588T21 5v14q0 .825-.587 1.413T19 21zm-2-4l-1.375-1.45l2.55-2.55H3v-2h8.175l-2.55-2.55L10 7l5 5z"/></svg>
                    </div>
