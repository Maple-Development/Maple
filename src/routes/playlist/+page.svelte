...
{#if !editModeOn}
	{#if listType !== 'list'}
		<div
			class="my-5 ml-4 mr-2 grid grid-cols-2 gap-x-4 gap-y-6 sm:grid-cols-2 sm:gap-x-6 md:ml-16 md:mr-0 md:grid-cols-3 md:gap-x-8 lg:grid-cols-4 lg:gap-x-10 xl:grid-cols-5 xl:gap-x-12"
		>
