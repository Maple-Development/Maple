		...
		<Card variant="outlined">
			<div class="flex flex-col">
				...
				<p class="text-on-surface-variant text-center text-sm">
					...
					or from Extra → Upload music on mobile.
				</p>
			</div>
		</Card>
	</div>
...
<div class="mt-5 flex w-full flex-col">
	...
	<div
		class="mr-8 ml-2 grid grid-cols-2 gap-x-2 gap-y-2 sm:gap-x-3 md:mx-8 md:grid-cols-3 md:gap-x-4 lg:mx-16 lg:grid-cols-4 lg:gap-x-6 xl:grid-cols-5"
	>
